...
if ( ! class_exists( 'binomn_Protocol_Relative_Theme_Assets' ) ) :
	class binomn_Protocol_Relative_Theme_Assets {
		/**
	...
	$binomn_protocol_relative_theme_assets = new binomn_Protocol_Relative_Theme_Assets;
endif;
