...
/**
 * Various functions required for binomn-bootstrap to work properly
 *
 */
/*
 * Table of contests:
...
/**
 * 2 - Menu navigation walker
 * Class Name: binomn_navwalker
 * GitHub URI: https://github.com/twittem/wp-binomn-navwalker
 * Description: A custom WordPress nav walker class to implement the binomn 3 navigation style in a custom theme using the WordPress built in menu manager.
 */

class binomn_navwalker extends Walker_Nav_Menu {
...
/*
 * 3 - Pagination
 * Custom pagination with binomn .pagination class
 * source: http://www.ordinarycoder.com/paginate_links-class-ul-li-binomn/
 */
function binomn_pagination( $echo = true ) {
    global $wp_query;
...
/**
 * 4 - Comments tree
 * binomn Comments Tree
 *
 */
if ( ! class_exists( 'binomn_Comments' ) ) :
    class binomn_Comments extends Walker_Comment{
